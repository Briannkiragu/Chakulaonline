...
"""
Django settings for chakulaonline_main project.
...
INSTALLED_APPS = [
    # needed for CSRF and site framework usage
    ...
    # Add custom apps here, for example "accounts"
'accounts',
'vendor',
'menu',
'marketplace',
...
MIDDLEWARE = [
    ...
    "orders.request_object.RequestObjectMiddleware",  # Add the custom middleware here
]

ROOT_URLCONF = "chakulaonline_main.urls"
...
WSGI_APPLICATION = "chakulaonline_main.wsgi.application"
...
#static files not working check on it
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'static'
STATICFILES_DIRS = [
    BASE_DIR / 'chakulaonline_main' / 'static'
]
